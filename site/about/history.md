...
**2025/08 计划开始** <br>
在了解 `.tmpl` 文件的一些简单原理后，打算想写一个新的博客生成工具，虽然计划暂搁了一会，但还是在九月中期继续折腾，设计大部分仿照着 [lume_theme_shiraha](https://github.com/importantimport/lume_theme_shiraha) 做，小部分设计参考之前使用的 [Urara](https://github.com/importantimport/urara)

**2025/10 接近可用状态** <br>
在一阵子一手 GPT 一手 Google 的情况下，已经解决了大部分看上去有问题的样式，尽管代码部分还不怎么样，但至少能用了，更多内容详见 [new tplate](/newtplate/) 文章
